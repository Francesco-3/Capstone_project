...
export default function AsideLeft() {
  ...
  return (
    <div className={classNames("sidebar d-flex flex-column h-100 position-sticky align-items-center", { collapsed })} style={{ border: "var(--border)" }}>
      {/* Bottone collapse */}
      ...
      <Nav className="sidebar-links w-75 flex-column justify-content-space-between">
