...
export default function GearSet({ positionClass }) {
  return (
    <>
      <style jsx="true">{`
        /* Variabili per un aspetto in Acciaio Scuro coesivo con Bootstrap */
        :root {
          --gear-color: #495057; /* Dark Gray (simile a bg-secondary di Bootstrap) */
          --gear-shadow: #212529; /* Quasi nero */
          --gear-highlight: #ADB5BD; /* Grigio chiaro */
        }
        ...
        /* Contenitore specifico per le ruote dentate (usa positionClass per posizionamento) */
        .gear-box-container {
          position: absolute;
          width: 250px; 
          height: 250px;
        ...
        /* Posizionamento gestito dalle classi esterne (left/right) */
        .gear-box-container.left {
          bottom: 15vh;
          left: 5vw;
          transform: scale(0.8) rotate(45deg);
        }
        
        .gear-box-container.right {
          top: 15vh;
          right: 5vw;
          transform: scale(0.8);
        }

        /* Stili Generali degli Ingranaggi - CUSTOM CSS */
        .gearbox .overlay {
          border-radius: 6px;
          content: "";
          position: absolute;
        ...
        .gear {
          ...
          height: 60px;
          width: 60px;
          box-shadow: 0px -1px 0px 0px var(--gear-highlight), 0px 1px 0px 0px var(--gear-shadow);
          border-radius: 30px;
        }
        ...
        .gear:after {
          ...
          width: 36px;
          border-radius: 36px;
          background: var(--gear-shadow);
          top: 50%;
          left: 50%;
          margin-left: -18px;
          margin-top: -18px;
          z-index: 3;
          box-shadow: 0px 0px 10px rgba(255, 255, 255, 0.1), inset 0px 0px 10px rgba(0, 0, 0, 0.1), inset 0px 2px 0px 0px var(--gear-shadow), inset 0px -1px 0px 0px var(--gear-highlight);
        }
      ...
      {/* Markup HTML delle ruote dentate */}
      <div className={`gear-box-container ${positionClass || ''} d-none d-md-block`}>
