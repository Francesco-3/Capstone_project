...
public record ProductDTO(
        ...
        @Size(max = 5, message = "Il codice seriale del prodotto deve essere di massimo 5 caratteri!")
        String productCode,

        @NotBlank(message = "La descrizione è obbligatoria!")
        @Size(min = 50, message = "La descrizione deve essere minimo di 50 caratteri!")
        String description,
